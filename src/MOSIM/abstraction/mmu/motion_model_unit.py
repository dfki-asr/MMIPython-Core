...
class MotionModelUnit(MotionModelInterface):
    ...
    def __init__(self, service_access, scene_access, mmu_access, adapter_access, sessionID, description):
        ...
        description : MMUDescription
            The mmu description
        """
        assert (isinstance(mmu_access, MOSIM.abstraction.mmu.mmu_access.MMUAccess)), "mmu_access is no MMUAccess."
        assert (isinstance(adapter_access, MOSIM.abstraction.access.interface.adapter_access.IAdapterAccess)), "adapter_access is no IAdapter."
