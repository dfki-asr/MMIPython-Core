...
class IAdapterAccess(object):
    ...
    def __init__(self, mmuAccess):
        ...
        assert (isinstance(mmuAccess, MOSIM.abstraction.mmu.mmu_access.MMUAccess)),"mmuAccess is no MMUAccess"
    ...
    def create_mmu_connections(self, mmu_descriptions, sessionID):
        ...
        for id in available_mmus:
            ...
            if len(description) > 0:
                ...
                # Create a connection
                result.append(MOSIM.abstraction.mmu.motion_model_unit.MotionModelUnit(self._mmuAccess.service_access, 
